...
public class AddTorrentParams implements Parcelable
{
    ...
    public AddTorrentParams(@NonNull String source,
                            ...
                            boolean addPaused)
    {
        this(source, fromMagnet, sha1hash, name, filePriorities, downloadPath, sequentialDownload, addPaused, false);
    }
    ...
    public void writeToParcel(Parcel dest, int flags)
    {
        ...
        dest.writeByte((byte)(startStream ? 1 : 0));
    }
