...
public class SettingsRepositoryImpl implements SettingsRepository
{
    private static class Default
    {
        ...
        static final boolean unmeteredConnectionsOnly = true;
        static final boolean enableRoaming = true;
        static final boolean builtInPlayer = true;
        /* Network settings */
    ...
    @Override
    public boolean enableBuiltInPlayer()
    {
        return pref.getBoolean(appContext.getString(R.string.pref_key_built_in_player),
                Default.builtInPlayer);
    }

    @Override
    public void enableBuiltInPlayer(boolean val)
    {
        pref.edit()
                .putBoolean(appContext.getString(R.string.pref_key_built_in_player), val)
                .apply();
    }
