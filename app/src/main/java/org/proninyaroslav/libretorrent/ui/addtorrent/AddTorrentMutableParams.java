...
public class AddTorrentMutableParams extends BaseObservable
{
    ...
    private boolean fromTorrentStream = false;
    private String name;
    ...
    public boolean isFromTorrentStream()
    {
        return fromTorrentStream;
    }

    public void setFromTorrentStream(boolean fromTorrentStream)
    {
        this.fromTorrentStream = fromTorrentStream;
    }
