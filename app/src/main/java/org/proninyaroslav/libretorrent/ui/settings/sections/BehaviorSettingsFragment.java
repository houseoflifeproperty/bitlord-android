        ...
        implements Preference.OnPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        String keyBuiltInPlayer = getString(R.string.pref_key_built_in_player);
        SwitchPreferenceCompat builtInPlayer = findPreference(keyBuiltInPlayer);
        if (builtInPlayer != null) {
            builtInPlayer.setChecked(pref.enableBuiltInPlayer());
            bindOnPreferenceChangeListener(builtInPlayer);
        }
    }
    ...
    public boolean onPreferenceChange(final Preference preference, Object newValue)
    {
        ...
        } else if (preference.getKey().equals(getString(R.string.pref_key_built_in_player))) {
            pref.enableBuiltInPlayer((boolean)newValue);
