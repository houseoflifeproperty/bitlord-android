    ...
    implements Selectable<TorrentListItem>
{
    ...
    public TorrentListAdapter(ClickListener listener, MainViewModel mainViewModel)
    {
        super(diffCallback);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.bind(item, isOpened, listener, mainViewModel);
        ...
        implements ViewHolderWithDetails
    {
        ...
        void bind(TorrentListItem item, boolean isOpened, ClickListener listener, MainViewModel mainViewModel)
        {
            ...
            binding.torrentOptionButton.setOnClickListener((View v) -> {
                ...
                popup.inflate(R.menu.main_action_mode);

                Menu pMenu = popup.getMenu();
                if (!mainViewModel.torrentHasMediaFile(item.torrentId))
                    pMenu.findItem(R.id.play_torrent_menu).setVisible(false);
    ...
    public interface ClickListener
    {
        ...
        boolean onMenuItemClick(int itemID, int position, TorrentListItem item);
    }
