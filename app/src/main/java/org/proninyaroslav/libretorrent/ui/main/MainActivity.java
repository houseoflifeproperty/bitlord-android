...
public class MainActivity extends AppCompatActivity implements FragmentCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        checkIfNeedStreamTorrent(getIntent());
    }
    ...
    protected void onNewIntent(Intent intent)
    {
        ...
        checkIfNeedStreamTorrent(intent);
    }

    private void checkIfNeedStreamTorrent(Intent intent)
    {
        String streamTorrentID = intent.getStringExtra("EXTRA_STREAM_TORRENT_ID");
        if (streamTorrentID != null && viewModel.isTorrentNeedStartStreamOnAdded(streamTorrentID))
        {
            Timer timer = new Timer();
            timer.schedule(new MainActivity.PlayStreamTask(streamTorrentID), 500);
        }
    }
    ...
    private void initLayout()
    {
        ...
        toolbar.setLogo(R.drawable.ic_app_toolbar);
    ...
    class PlayStreamTask extends TimerTask
    {
        ...
        public PlayStreamTask(String torrentID)
        {
        ...
        public void run()
        {
            ...
            if (fragment instanceof MainFragment) {
                ((MainFragment)fragment).playFile(viewModel.getFirstMediaFile(torrentID));
            }
        }
    }
}
